...
public class ObstTorteImplTest {
        ...
        void setUp() throws Exception {
            ...
            kuchen = new ObsttorteImpl(hersteller, "apfel","vanille", allergene, BigDecimal.valueOf(1.99), 300,automatMock,haltbarkeit);
            when(automatMock.getInspektionsdatum(kuchen)).thenReturn(newDate);
            when(automatMock.getFachnummer(kuchen)).thenReturn(42);
        }
    ...
    void getKuchenArtTest()  {
        ...
        /* ZUSICHERUNG */
        KuchenArt expected = KuchenArt.Obsttorte;
        Assertions.assertEquals(expected, actual);
    }
    ...
    void toStringTest() {
        ...
        /* ZUSICHERUNG */
        String expected = "fachnummer=42, preis=1.99, inspektionsdatum="+newDate+"kuchenArt=Obsttorte, hersteller=rewe, naehrwert=300, Hltbr verbleibend (h):24, allergene=[Haselnuss, Gluten, Sesamsamen], Obstsorte=apfel, kremsorte=vanille";
        Assertions.assertEquals(expected, actual);
    }
}
